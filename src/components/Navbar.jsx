    ...
    <nav className={`navbar ${scrolled ? 'scrolled' : ''}`}>
      <div className="nav-container">
        ...
        <div className={`nav-links ${isOpen ? 'active' : ''}`}>
          ...
          <Link to="/blogs" className={location.pathname === '/blogs' ? 'active-link' : ''} onClick={closeMenu}>Blogs</Link>
          <Link to="/videos" className={location.pathname === '/videos' ? 'active-link' : ''} onClick={closeMenu}>Videos</Link>
